        ...
        >
          ...
          <div className="w-full lg:w-7/12 px-4">
            <div className="p-4 md:p-6 lg:p-8 rounded-2xl" style={{ background: 'rgba(205, 241, 216, 0.2)' }}>
              <div className="mb-6">
                <h1 className="text-3xl md:text-4xl font-bold mb-1" style={{ color: themeColors.primary }}>Roman Richards</h1>
          ...
          >
            <div className="bg-white p-6 rounded-2xl shadow-sm">
              ...
              <p className="text-gray-700 leading-relaxed">
                Roman Richard is an Emmy-winning sound designer and mixer based in Los Angeles. Growing up in Southern California, his love for music and creativity led him to work with top global brands such as Nike, Red Bull, and Mercedes-Benz. Roman has sound designed for live events in arenas and stadiums, bringing his love for sports into his audio work. A flutist first, Roman brings his musical background into every project, blending technical expertise with artistic vision to create compelling audio experiences.
              </p>
            </div>
          </div>
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto">
              Explore some of Roman's most impactful audio work, showcasing his versatility across brands and platforms.
            </p>
          </div>
